		...
		<Layout span={12} offset={6}>
			<Content>
				<Col span={24}>
				 ...
				 <Image src="https://wallpaperaccess.com/full/1343405.jpg" preview={false} className={styles.landingImage}/> 
				</Col> 

				<ContentRow contents={Movies.slice(0, 4)}/>
			 
			 	<ContentRow contents= {Movies.slice(0, 4)} title={"PICKED FOR YOU"}/>
